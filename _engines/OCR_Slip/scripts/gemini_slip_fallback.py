...
# -*- coding: utf-8 -*-
"""
_engines/OCR_Slip/scripts/gemini_slip_fallback.py — Gemini Multimodal Emergency Fallback (Engine Mirror)
    ...
    if typhoon_key:
        try:
            try:
                ...
                from _engines.OCR_Slip.scripts.typhoon_slip_engine import extract_slip_with_typhoon
