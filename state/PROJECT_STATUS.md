...
- [x] **Decoupled Standalone Dossier Architecture:** แยกชุดหน้าปกและสารบัญ 10 คอลัมน์ Landscape (6 หน้า) ออกเป็น `Folder_Out/Evidence_Chat_Master_Front_Cover_and_Index.pdf` เดี่ยว ไม่ผสานกลืนเข้าเล่มแชท ทำให้เล่มแชทเริ่มต้นที่ Physical Page 1 ตรงกับเลขหน้าพิมพ์ 100% สั่งพิมพ์หน้า 1 ออกแชทหน้า 1 ทันที ไม่ต้องบวกเลขหน้า
- [x] **Streaming Canvas Pipeline Overhaul:** ยกเครื่องกระบวนการตัดต่อภาพแชทจากการแบ่งแบทช์ 35 ภาพเดิม สู่การต่อสายพานยาวต่อเนื่องชิ้นเดียวแล้วสไลซ์ตาม Quiet Zone ขจัดรอยต่อแบทช์ รอยตัดผ่ากลางข้อความ และลดจำนวนหน้าขยะจาก 2,560 หน้า เหลือ **2,387 หน้า A4 บริสุทธิ์ (ลดลง 173 หน้า)**
- [x] **Post-Slice Deduplication Rule (Rule 14):** ติดตั้งด่านตรวจจับภาพซ้ำหลังการหั่นหน้ากระดาษ ตรวจสอบ SHA-256 Content Hash และ Slip Reference ID ทันที หากซ้ำกับหน้าก่อนหน้าให้ตัดทิ้งอัตโนมัติ
- [x] **Zero Duplicate Pages Audit (2,387 หน้า):** ตรวจสอบระดับไบนารี Image Xref & SHA-256 Stream ยืนยันพบ 0 Duplicates (ไม่มีหน้าซ้ำเลยแม้แต่หน้าเดียว) 100% ตลอดทั้งเล่ม 2,387 หน้า
- [x] **Master Financial Slip Ledger (94 Slips / 467,218.00 THB):** สแกนดัชนีสลิปใหม่ทั้งหมด 94 รายการ ผูกโยงบัญชีที่พิสูจน์แล้ว (Option 1 Verified Account Binding) ปราศจากเลขบัญชีหลุดในช่องชื่อ พร้อมส่งออก Excel และ JSON สมบูรณ์
